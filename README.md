...
<img src="https://komarev.com/ghpvc/?username=awais0198&style=flat-square&color=red" alt=""/>
...
- 🔭 Senior Software Engineer building full-stack, cloud-native products in **React, Next.js, Node.js & NestJS**
- 🏗️ Led a monolith → microservices migration and own CI/CD, GraphQL API design, and PostgreSQL/Redis performance work in production
- 🤖 Exploring **LLM inference, RAG pipelines, and AI system optimization**
- 📊 Comfortable turning raw data into dashboards and decisions — **Data Science & analytics**
- 🧠 AI-assisted development with **Claude** & **Cursor** to ship faster, cleaner code
- 📱 Shipped production **React Native** apps end-to-end (offline-first sync, performance tuning)
- 🌍 Based in Lahore, Pakistan — open to remote work & relocation
- ⚡ Fun fact: I debug faster with a coffee in hand than without
...
<p align="center">Built with ❤️, a lot of ☕, and some help from Claude</p>
